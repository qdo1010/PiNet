...
conv10 = (BinaryConv2D(10, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias,name='conv10'))(fire9_dropout)
...
with open("SX10.json", "w") as json_file:
    json_file.write(model_json)

filepath="SX10_weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
