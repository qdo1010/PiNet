...
#fire 1
fire2_squeeze = XnorConv2D(16, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(maxpool1) 
...
fire2_expand1 = XnorConv2D(64, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire2_squeeze) 
...
fire2_expand2 = XnorConv2D(64, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire2_squeeze) 
...
fire2 = merge1
#fire 2
fire3_squeeze = XnorConv2D(16, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire2) 
...
fire3_expand1 = XnorConv2D(64, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire3_squeeze)
...
fire3_expand2 = XnorConv2D(64, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire3_squeeze)
...
#fire 3
fire4_squeeze = XnorConv2D(32, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire3) 
...
fire4_expand1 = XnorConv2D(128, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire4_squeeze)
...
fire4_expand2 = XnorConv2D(128, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire4_squeeze)
...
#fire 5
fire5_squeeze = XnorConv2D(32, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(maxpool4)   
...
fire5_expand1 = XnorConv2D(128, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire5_squeeze)
...
fire5_expand2 = XnorConv2D(128, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire5_squeeze)
...
fire5 = merge5
#fire 6
fire6_squeeze = XnorConv2D(48, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire5) 
...
fire6_expand1 = XnorConv2D(192, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire6_squeeze)
...
fire6_expand2 = XnorConv2D(192, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire6_squeeze)
...
fire6 = merge6
#fire 7
fire7_squeeze = XnorConv2D(48, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire6) 
...
fire7_expand1 = XnorConv2D(192, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire7_squeeze)
...
fire7_expand2 = XnorConv2D(192, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire7_squeeze)
...
#fire 8
fire8_squeeze = XnorConv2D(64, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire7) 
...
fire8_expand1 = XnorConv2D(256, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire8_squeeze)
...
fire8_expand2 = XnorConv2D(256, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire8_squeeze)
...
#fire 9
fire9_squeeze = XnorConv2D(64, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(maxpool8) 
...
fire9_expand1 = XnorConv2D(256, kernel_size=(1, 1),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire9_squeeze)
...
fire9_expand2 = XnorConv2D(256, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias)(fire9_squeeze)
