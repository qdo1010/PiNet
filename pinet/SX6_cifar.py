...
conv1 = (XnorConv2D(96, kernel_size=(3, 3),H=H, kernel_lr_multiplier=kernel_lr_multiplier, padding='same',use_bias=use_bias,name='conv1'))(input_layer) 
...
#conv10 = BatchNormalization(epsilon=epsilon, momentum=momentum, axis=1, name='bn1')(conv1)
conv10 = BatchNormalization(name='conv10_bn')(conv10)
...
model.compile(loss='squared_hinge', optimizer='sgd', metrics=['acc'])
